...
Shader "DO/SEffect_sad_ins"
{
	Properties
	{
		...
		[ASEEnd]_ins("ins", Range( 2 , 10)) = 3.823319
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float3 Color = ( ( pow( _ins , 1.0 ) * tex2DNode10 ) * IN.ase_color ).rgb;
...
WireConnection;33;3;16;0
ASEEND*/
//CHKSM=E052769AEB17650154F6CAB858A1A778ECA92289