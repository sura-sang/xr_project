...
Shader "DO/Additve ANG"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[ASEBegin]_FresnelScale("Fresnel Scale", Range( 0 , 1)) = 0.8
		_FresnelPower("Fresnel Power", Range( 1 , 10)) = 5.447059
		_TintColor("Tint Color", Color) = (1,1,1,1)
		[ASEEnd]_Ins("Ins", Range( 1 , 20)) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float3 Color = ( IN.ase_color * ( _Ins * ( _TintColor * saturate( fresnelNode1 ) ) ) ).rgb;
...
ASEEND*/
//CHKSM=0F11CD0560FA05C19D968712D60604341836F5B1