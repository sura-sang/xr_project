...
Shader "DO/SEffect_sad_OUT"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[ASEBegin]_Vampire_diffuse("Vampire_diffuse", 2D) = "white" {}
		...
		[ASEEnd]_EdgeIns("Edge Ins", Range( 1 , 10)) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 _Vampire_diffuse_ST;
			float4 _Vampire_normal_ST;
			float4 _Vampire_emission_ST;
			...
			#endif
			CBUFFER_END
			sampler2D _Vampire_diffuse;
			sampler2D _Vampire_normal;
			sampler2D _Vampire_emission;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 ShadowCoords = float4( 0, 0, 0, 0 );
					...
					#endif
				#endif
				float2 uv_Vampire_diffuse = IN.ase_texcoord3.xy * _Vampire_diffuse_ST.xy + _Vampire_diffuse_ST.zw;
				float2 uv_Vampire_normal = IN.ase_texcoord3.xy * _Vampire_normal_ST.xy + _Vampire_normal_ST.zw;
				float2 uv_Vampire_emission = IN.ase_texcoord3.xy * _Vampire_emission_ST.xy + _Vampire_emission_ST.zw;
				...
				float4 temp_output_31_0 = ( _EdgeIns * ( _EdgeColor * saturate( ( step( 0.5 , temp_output_18_0 ) - step( _EdgeRange , temp_output_18_0 ) ) ) ) );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( ( tex2D( _Vampire_diffuse, uv_Vampire_diffuse ) * float4( UnpackNormalScale( tex2D( _Vampire_normal, uv_Vampire_normal ), 1.0f ) , 0.0 ) ) * ( ( tex2D( _Vampire_emission, uv_Vampire_emission ) + ( ( saturate( fresnelNode4 ) * _FresnelColor ) * _FresnelIns ) ) + temp_output_31_0 ) ).rgb;
				float Alpha = temp_output_31_0.r;
        ...
        Pass
        {
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				surfaceDescription.Alpha = temp_output_31_0.r;
...
/*ASEBEGIN
Version=18935
1069;715;1185;697;1024.09;655.0173;2.340567;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;19;-928.4631,814.8674;Float;False;Property;_Dissolve;Dissolve;8;0;Create;True;0;0;0;False;0;False;0;0.4040471;-1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;15;-932.9731,548.2155;Inherit;True;Property;_DissolveTexture;Dissolve Texture;7;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;26;-317.6587,831.642;Float;False;Property;_EdgeRange;Edge Range;9;0;Create;True;0;0;0;False;0;False;0.81;0.648062;0.5;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.StepOpNode;24;-78.25876,863.2413;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;30;298.5118,534.4026;Float;False;Property;_EdgeColor;Edge Color;10;0;Create;True;0;0;0;False;0;False;0,0,0,0;1,1,1,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;32;526.5118,540.4026;Float;False;Property;_EdgeIns;Edge Ins;11;0;Create;True;0;0;0;False;0;False;0;10;1;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;13;-427.9294,273.7771;Float;False;Property;_FresnelIns;Fresnel Ins;6;0;Create;True;0;0;0;False;0;False;5.545021;1.54;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;2;-332,-223;Inherit;True;Property;_Vampire_emission;Vampire_emission;1;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;1;-342,-614;Inherit;True;Property;_Vampire_diffuse;Vampire_diffuse;0;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;6;-1159.9,54.8;Float;False;Property;_FresnelScale;Fresnel Scale;3;0;Create;True;0;0;0;False;0;False;1.188235;4.687;1;5;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;46;1009.862,-60.51334;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;3;-341,-424;Inherit;True;Property;_Vampire_normal;Vampire_normal;2;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;7;-1152.9,130.8;Float;False;Property;_FresnelPow;Fresnel Pow;4;0;Create;True;0;0;0;False;0;False;5;5;1;5;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=080D086B3FDB79BB756AD49C9F721B103C42CD06