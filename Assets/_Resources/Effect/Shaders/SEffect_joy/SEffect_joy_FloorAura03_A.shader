...
Shader "Effect/joy_floorAura03"
{
	Properties
	{
		...
		_Alph("Alph", 2D) = "white" {}
		_Panner("Panner", Vector) = (0.1,0,0,0)
		_Alpha_Inten("Alpha_Inten", Float) = 0.8
		[ASEEnd]_Lerp("Lerp", Float) = 0.5
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 ShadowCoords = float4( 0, 0, 0, 0 );
					...
					#endif
				#endif
				half2 texCoord43 = IN.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				half2 CenteredUV15_g1 = ( texCoord43 - float2( 0.5,0.5 ) );
				half2 break17_g1 = CenteredUV15_g1;
				half2 appendResult23_g1 = (half2(( length( CenteredUV15_g1 ) * 1.0 * 2.0 ) , ( atan2( break17_g1.x , break17_g1.y ) * ( 1.0 / TWO_PI ) * 1.0 )));
				float2 center45_g2 = float2( 0.5,0.5 );
				float2 delta6_g2 = ( appendResult23_g1 - center45_g2 );
				float angle10_g2 = ( length( delta6_g2 ) * 0.0 );
				float x23_g2 = ( ( cos( angle10_g2 ) * delta6_g2.x ) - ( sin( angle10_g2 ) * delta6_g2.y ) );
				half2 break40_g2 = center45_g2;
				half mulTime56 = _TimeParameters.x * _Panner.x;
				half2 temp_cast_1 = (mulTime56).xx;
				half2 break41_g2 = temp_cast_1;
				...
				half4 temp_output_31_0 = ( _MainColor * _Inten * tex2Dlod( _MainTex, float4( appendResult44_g2, 0, 0.0) ) );
				half4 temp_cast_2 = (_POW).xxxx;
				half4 temp_cast_3 = (0.47).xxxx;
				half4 lerpResult61 = lerp( pow( temp_output_31_0 , temp_cast_2 ) , step( temp_output_31_0 , temp_cast_3 ) , _Lerp);
				float2 uv_Alph = IN.ase_texcoord3.xy * _Alph_ST.xy + _Alph_ST.zw;
				half4 temp_output_50_0 = ( lerpResult61 * tex2D( _Alph, uv_Alph ).a * _Alpha_Inten );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( IN.ase_color * saturate( lerpResult61 ) * temp_output_50_0 ).rgb;
				float Alpha = ( IN.ase_color.a * temp_output_50_0 ).r;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				half4 temp_cast_3 = (0.47).xxxx;
				half4 lerpResult61 = lerp( pow( temp_output_31_0 , temp_cast_2 ) , step( temp_output_31_0 , temp_cast_3 ) , _Lerp);
				float2 uv_Alph = IN.ase_texcoord2.xy * _Alph_ST.xy + _Alph_ST.zw;
				half4 temp_output_50_0 = ( lerpResult61 * tex2D( _Alph, uv_Alph ).a * _Alpha_Inten );
        ...
        Pass
        {
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				half2 texCoord43 = IN.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				half2 CenteredUV15_g1 = ( texCoord43 - float2( 0.5,0.5 ) );
				half2 break17_g1 = CenteredUV15_g1;
				half2 appendResult23_g1 = (half2(( length( CenteredUV15_g1 ) * 1.0 * 2.0 ) , ( atan2( break17_g1.x , break17_g1.y ) * ( 1.0 / TWO_PI ) * 1.0 )));
				float2 center45_g2 = float2( 0.5,0.5 );
				...
				half4 temp_cast_3 = (0.47).xxxx;
				half4 lerpResult61 = lerp( pow( temp_output_31_0 , temp_cast_2 ) , step( temp_output_31_0 , temp_cast_3 ) , _Lerp);
				float2 uv_Alph = IN.ase_texcoord.xy * _Alph_ST.xy + _Alph_ST.zw;
				half4 temp_output_50_0 = ( lerpResult61 * tex2D( _Alph, uv_Alph ).a * _Alpha_Inten );
				
				surfaceDescription.Alpha = ( IN.ase_color.a * temp_output_50_0 ).r;
        ...
        Pass
        {
			...
			{
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				half2 texCoord43 = IN.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				half2 CenteredUV15_g1 = ( texCoord43 - float2( 0.5,0.5 ) );
				half2 break17_g1 = CenteredUV15_g1;
				half2 appendResult23_g1 = (half2(( length( CenteredUV15_g1 ) * 1.0 * 2.0 ) , ( atan2( break17_g1.x , break17_g1.y ) * ( 1.0 / TWO_PI ) * 1.0 )));
				float2 center45_g2 = float2( 0.5,0.5 );
				...
				half4 temp_cast_3 = (0.47).xxxx;
				half4 lerpResult61 = lerp( pow( temp_output_31_0 , temp_cast_2 ) , step( temp_output_31_0 , temp_cast_3 ) , _Lerp);
				float2 uv_Alph = IN.ase_texcoord1.xy * _Alph_ST.xy + _Alph_ST.zw;
				half4 temp_output_50_0 = ( lerpResult61 * tex2D( _Alph, uv_Alph ).a * _Alpha_Inten );
...
/*ASEBEGIN
Version=18935
1258;81;970;748;2812.982;1966.869;5.25419;True;False
Node;AmplifyShaderEditor.Vector2Node;57;-1497.573,525.822;Inherit;False;Property;_Panner;Panner;5;0;Create;True;0;0;0;False;0;False;0.1,0;0.1,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.TextureCoordinatesNode;43;-1662.403,295.3629;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleTimeNode;56;-1308.729,530.313;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;40;-1360.143,297.7856;Inherit;False;Polar Coordinates;-1;;1;7dab8e02884cf104ebefaa2e788e4162;0;4;1;FLOAT2;0,0;False;2;FLOAT2;0.5,0.5;False;3;FLOAT;1;False;4;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.FunctionNode;53;-1050.575,377.7615;Inherit;False;Twirl;-1;;2;90936742ac32db8449cd21ab6dd337c8;0;4;1;FLOAT2;0,0;False;2;FLOAT2;0,0;False;3;FLOAT;0;False;4;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;32;-338.7452,180.0483;Inherit;False;Property;_Inten;Inten;0;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;33;-400.8958,-30.74252;Inherit;False;Property;_MainColor;MainColor;1;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;38;-735.4175,369.1041;Inherit;True;Property;_MainTex;MainTex;3;0;Create;True;0;0;0;False;0;False;-1;2666fbd93c88a0444857ac8dfe081fb7;e8f2ac9b4ea8c2741b3abb7c552fe2f8;True;0;False;white;Auto;False;Object;-1;MipLevel;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;31;-160.7822,195.5984;Inherit;False;3;3;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;36;-126.1847,76.03687;Inherit;False;Property;_POW;POW;2;0;Create;True;0;0;0;False;0;False;0.9;0.9;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;60;-104.2978,523.5798;Inherit;False;Constant;_Float1;Float 1;7;0;Create;True;0;0;0;False;0;False;0.47;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.StepOpNode;59;61.97595,421.0061;Inherit;True;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;62;279.7551,480.2036;Inherit;False;Property;_Lerp;Lerp;7;0;Create;True;0;0;0;False;0;False;0.5;0.3;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;35;58.53362,-27.57267;Inherit;True;False;2;0;COLOR;0,0,0,0;False;1;FLOAT;1;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;44;656.992,664.4343;Inherit;True;Property;_Alph;Alph;4;0;Create;True;0;0;0;False;0;False;-1;ac2ff79da9978c54db2b39c238cb7e3b;467207aaac8512b498a34dd6d2e979da;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;52;804.902,880.4501;Inherit;False;Property;_Alpha_Inten;Alpha_Inten;6;0;Create;True;0;0;0;False;0;False;0.8;1.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;61;451.7551,277.2036;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;50;1031.129,533.2892;Inherit;True;3;3;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.VertexColorNode;24;1003.194,-402.9353;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;23;1277.658,-138.0184;Inherit;False;3;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SaturateNode;37;941.8008,15.69107;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;58;1306.118,100.5089;Inherit;True;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;1621.343,-308.9069;Half;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;3;Effect/joy_floorAura03;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;2;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;2;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;5;False;-1;10;False;-1;1;1;False;-1;10;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;2;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForwardOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;22;Surface;1;637994153559163481;  Blend;0;638029789967430145;Two Sided;0;638007993188555324;Cast Shadows;1;0;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;0;0;Built-in Fog;0;0;DOTS Instancing;0;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,-1;0;  Type;0;0;  Tess;16,False,-1;0;  Min;10,False,-1;0;  Max;25,False,-1;0;  Edge Length;16,False,-1;0;  Max Displacement;25,False,-1;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;False;True;True;True;False;True;True;True;True;True;False;;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;0;-791.9722,-193.7347;Float;False;False;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;3;New Amplify Shader;2992e84f91cbeb14eab234972e07ea9d;True;ExtraPrePass;0;0;ExtraPrePass;5;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;2;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;0;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
