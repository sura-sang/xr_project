...
Shader "Effect/joy_floorAura03"
{
	Properties
	{
		...
		[ASEEnd]_Alph_Inten("Alph_Inten", Float) = 3
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 CenteredUV15_g3 = ( texCoord43 - float2( 0.5,0.5 ) );
				...
				float2 delta6_g2 = ( appendResult23_g3 - center45_g2 );
				...
				float mulTime56 = _TimeParameters.x * _Panner.x;
				float2 temp_cast_1 = (mulTime56).xx;
				...
				float4 tex2DNode38 = tex2Dlod( _MainTex, float4( appendResult44_g2, 0, 0.0) );
				float4 temp_cast_2 = (_POW).xxxx;
				float2 uv_Alph = IN.ase_texcoord3.xy * _Alph_ST.xy + _Alph_ST.zw;
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( IN.ase_color * saturate( pow( ( _MainColor * _Inten * tex2DNode38 ) , temp_cast_2 ) ) * ( tex2DNode38.r * tex2D( _Alph, uv_Alph ).r * _Alph_Inten ) ).rgb;
...
/*ASEBEGIN
Version=18935
1258;81;970;748;1848.86;542.5865;2.469447;True;False
Node;AmplifyShaderEditor.VertexColorNode;24;1003.194,-402.9353;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;31;365.3429,174.1239;Inherit;False;3;3;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;32;187.3799,158.5738;Inherit;False;Property;_Inten;Inten;0;0;Create;True;0;0;0;False;0;False;1;1.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;37;941.8008,15.69107;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;38;-209.292,347.6295;Inherit;True;Property;_MainTex;MainTex;3;0;Create;True;0;0;0;False;0;False;-1;2666fbd93c88a0444857ac8dfe081fb7;049ff8246fe7fb14e9986674b0318fca;True;0;False;white;Auto;False;Object;-1;MipLevel;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;33;125.2294,-52.21701;Inherit;False;Property;_MainColor;MainColor;1;0;Create;True;0;0;0;False;0;False;1,1,1,0;0.3867923,0.2611845,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;36;380.901,336.3439;Inherit;False;Property;_POW;POW;2;0;Create;True;0;0;0;False;0;False;0.9;0.9;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;40;-834.0181,276.311;Inherit;False;Polar Coordinates;-1;;3;7dab8e02884cf104ebefaa2e788e4162;0;4;1;FLOAT2;0,0;False;2;FLOAT2;0.5,0.5;False;3;FLOAT;1;False;4;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;52;804.902,880.4501;Inherit;False;Property;_Alph_Inten;Alph_Inten;6;0;Create;True;0;0;0;False;0;False;3;10;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;43;-1136.278,273.8883;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;23;1277.658,-138.0184;Inherit;False;3;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;53;-524.4494,356.2869;Inherit;False;Twirl;-1;;2;90936742ac32db8449cd21ab6dd337c8;0;4;1;FLOAT2;0,0;False;2;FLOAT2;0,0;False;3;FLOAT;0;False;4;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.PowerNode;35;578.9469,103.2672;Inherit;True;False;2;0;COLOR;0,0,0,0;False;1;FLOAT;1;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleTimeNode;56;-782.604,508.8385;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;57;-971.448,504.3474;Inherit;False;Property;_Panner;Panner;5;0;Create;True;0;0;0;False;0;False;0.1,0;0.1,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.SamplerNode;44;656.992,664.4343;Inherit;True;Property;_Alph;Alph;4;0;Create;True;0;0;0;False;0;False;-1;bdfa5a3e424390e41bfc30538954424b;bdfa5a3e424390e41bfc30538954424b;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;50;1031.129,533.2892;Inherit;True;3;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=F741981E991904E7674D88593B0F4E54EB16B5EA