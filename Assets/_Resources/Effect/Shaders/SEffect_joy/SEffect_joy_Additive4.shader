		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 ShadowCoords = float4( 0, 0, 0, 0 );
					...
					#endif
				#endif
				float4 color20 = IsGammaSpace() ? float4(0.945098,0.7200013,0.2196078,1) : float4(0.8796223,0.4770017,0.03954624,1);
				...
				float3 Color = ( IN.ase_color * ( ( _Float1 * ( color20 * tex2D( _TextureSample0, appendResult16 ).r ) ) * saturate( pow( ( ( texCoord24.x * ( 1.0 - texCoord24.x ) ) * 4.0 ) , 4.0 ) ) ) ).rgb;
...
/*ASEBEGIN
Version=18935
1694;81;519;748;1654.188;955.093;3.823454;True;False
...
Node;AmplifyShaderEditor.SamplerNode;17;-620.0713,9.766968;Inherit;True;Property;_TextureSample0;Texture Sample 0;1;0;Create;True;0;0;0;False;0;False;-1;21a728a77f3d5ed46a4cab303fa27239;21a728a77f3d5ed46a4cab303fa27239;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;22;-291.1526,-330.5233;Half;False;Property;_Float1;Float 1;2;0;Create;True;0;0;0;False;0;False;2.729412;2.729412;1;50;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;20;-603.8127,-207.7275;Inherit;False;Constant;_Color0;Color 0;2;0;Create;True;0;0;0;False;0;False;0.945098,0.7200013,0.2196078,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;29;-623.4771,542.6147;Inherit;False;Constant;_Float2;Float 2;3;0;Create;True;0;0;0;False;0;False;4;0;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=EBB6ED6D61E26D76532EE0D6F8F0F791F79051F3