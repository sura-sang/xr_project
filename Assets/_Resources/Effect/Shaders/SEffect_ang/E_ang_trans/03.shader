...
Shader "E_ang/trans03"
{
	Properties
	{
		...
		_Color0("Color 0", Color) = (1,0.3337444,0.09803921,1)
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float3 Color = ( IN.ase_color * ( ( _Float1 * ( _Color0 * tex2D( _TextureSample0, appendResult16 ).r ) ) * saturate( pow( ( ( texCoord24.x * ( 1.0 - texCoord24.x ) ) * 4.0 ) , 4.0 ) ) ) ).rgb;
...
/*ASEBEGIN
Version=18935
2095;203;985;491;779.9772;455.815;1;True;False
...
Node;AmplifyShaderEditor.ColorNode;20;-602.2988,-207.7275;Inherit;False;Property;_Color0;Color 0;2;0;Create;True;0;0;0;False;0;False;1,0.3337444,0.09803921,1;1,0.3337444,0.09803921,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;36;-233.9772,-265.815;Inherit;False;Property;_Float1;Float 1;3;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=ED2C3C642647E4EF87B5231D7E28C06EB75B0C9F