...
Shader "E_ang/E_ang_walk"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[ASEBegin]_E_ang_surcl("E_ang_surcl", 2D) = "white" {}
		_E_ang_fire_noise01("E_ang_fire_noise01", 2D) = "white" {}
		_T8("T8", 2D) = "white" {}
		_inten("inten", Float) = 1
		[ASEEnd]_Color0("Color 0", Color) = (0.4339623,0.07082371,0,0)
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 panner17 = ( 1.0 * _Time.y * float2( 0,-1 ) + texCoord18);
				float4 temp_output_27_0 = ( tex2D( _E_ang_surcl, texCoord19 ) * saturate( pow( ( tex2D( _E_ang_fire_noise01, texCoord26 ).r * tex2D( _T8, panner17 ).r ) , 0.2 ) ) );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( _inten * _Color0 * IN.ase_color * temp_output_27_0 ).rgb;
				float Alpha = ( temp_output_27_0 * IN.ase_color.a ).r;
        ...
        Pass
        {
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				surfaceDescription.Alpha = ( temp_output_27_0 * IN.ase_color.a ).r;
...
/*ASEBEGIN
Version=18935
2039;155;900;715;1044.096;-68.51498;1;True;False
Node;AmplifyShaderEditor.TextureCoordinatesNode;18;-1976.651,514.896;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector2Node;21;-1933.749,659.1967;Inherit;False;Constant;_Vector0;Vector 0;4;0;Create;True;0;0;0;False;0;False;0,-1;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.TextureCoordinatesNode;26;-1762.707,261.1601;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.PannerNode;17;-1725.747,512.296;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SamplerNode;12;-1449.41,247.1312;Inherit;True;Property;_E_ang_fire_noise01;E_ang_fire_noise01;1;0;Create;True;0;0;0;False;0;False;-1;0f757346a3381ef47a7036340f224839;0f757346a3381ef47a7036340f224839;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;13;-1482.971,501.0001;Inherit;True;Property;_T8;T8;2;0;Create;True;0;0;0;False;0;False;-1;a0cb17c1877af404daa57ed0b9b0ddf9;a0cb17c1877af404daa57ed0b9b0ddf9;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;32;-854.4987,530.5358;Inherit;False;Constant;_Float0;Float 0;4;0;Create;True;0;0;0;False;0;False;0.2;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;23;-1074.693,373.995;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;30;-727.8876,415.5622;Inherit;False;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;19;-989.5046,80.9498;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;11;-691.3407,129.6505;Inherit;True;Property;_E_ang_surcl;E_ang_surcl;0;0;Create;True;0;0;0;False;0;False;-1;d2eb3ceb8b0ca4b48965d98a2108624b;d2eb3ceb8b0ca4b48965d98a2108624b;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SaturateNode;31;-511.4987,396.5358;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;27;-343.512,230.2523;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.VertexColorNode;14;-406.4967,12.65049;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;16;-453.6967,-258.3495;Inherit;False;Property;_inten;inten;3;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;28;-145.4582,31.97528;Inherit;False;4;4;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;29;-54.97272,262.3468;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;15;-505.6966,-168.6496;Inherit;False;Property;_Color0;Color 0;4;0;Create;True;0;0;0;False;0;False;0.4339623,0.07082371,0,0;0.4339623,0.1794102,0.07164471,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;29;1;14;4
WireConnection;2;2;28;0
WireConnection;2;3;29;0
ASEEND*/
//CHKSM=1BE606193C6FB27A946A6DD99BD804126CC489A8